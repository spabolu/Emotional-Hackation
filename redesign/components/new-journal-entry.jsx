...
export default function NewJournalEntry({ onClose }) {
  ...
  const therapistRef = useRef(null);       // <--- For scrolling to squirrel
  ...
  const handleSave = () => {
    ...
    // Scroll down to squirrel after a tiny delay
    setTimeout(() => {
    ...
    <>
      ...
      >
        ...
        >
          {/* Header */}
          <div className="p-4 border-b border-fuchsia-200 bg-white/90 backdrop-blur sticky top-0 z-10 flex items-center justify-between">
            <h2 className="text-xl font-bold text-fuchsia-900">Create New Journal Entry</h2>
            <Button variant="ghost" size="icon" onClick={onClose} className="text-fuchsia-600 hover:text-fuchsia-700 cursor-pointer">
              <X className="h-5 w-5" />
            </Button>
          </div>

          {/* Content area with AiTherapist inside */}
          <div ref={contentRef} className="flex-1 overflow-y-auto py-4 px-6">
            <div className="space-y-3">
              <div className="space-y-2">
                <label htmlFor="title" className="text-sm font-medium text-fuchsia-900">Title</label>
                <Input
                  id="title"
                  placeholder="Give your entry a title..."
                  value={title}
              ...
              <div className="space-y-2">
                <label htmlFor="content" className="text-sm font-medium text-fuchsia-900">Journal Entry</label>
                <Textarea
                  id="content"
                  placeholder="Write your thoughts, reflections, and feelings..."
                  value={content}
